...
class BuyDropsRequest(BaseModel):
    walletAddress:   str
    expectedGAmount: float
    gTxHash:         str
    dropsAmount:     Optional[float] = None
...
class ClaimRequest(BaseModel):
    ...
    @property
    def resolved_wallet(self) -> str:
        return (self.wallet or self.walletAddress or "").lower()